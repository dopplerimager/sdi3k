...
;  already exist.
;
pro sdi3k_write_windfitpars, ncid, mm, windfit, settings, wind_offset, geofit=geofit
       ...
       sdi3k_addvar, ncid, 'Peak_Position_Offset',      [zoneid], $
                           'Spectral Channels',   /float
...
on_ioerror, NULL
       if n_elements(wind_offset) eq mm.nzones then $
       ncdf_varput, ncid, ncdf_varid(ncid,       'Peak_Position_Offset'),      wind_offset
