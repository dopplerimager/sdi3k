...
pro sdi3k_rt_build_filenames, skysrc, skydest, calsrc, caldest, semaphore, messages
    ...
    srcpath = '\\137.229.18.164\SDI_Data\'
    dstpath = 'd:\users\sdi3000\realtime_data\'
...
;skydest = 'd:\users\sdi3000\realtime_data\PKR 2012_003_Poker_630nm_Red_Sky_Date_01_03.nc'
;caldest = 'd:\users\sdi3000\realtime_data\PKR 2012_003_Poker_Laser6328_Red_Cal_Date_01_03.pf'
;skydest = 'D:\users\SDI3000\realtime_data\PKR_2012_286_Date_10_12_SKY_6300_NZ0115.nc'
;caldest = 'd:\users\sdi3000\realtime_data\PKR_2012_286_Date_10_12_CAL_6328_NZ0115.nc'
;newrex = 0
;setenv, 'SDI3K_FORCE_REALTIME_PLOT_UPDATE=YES'
;goto, skip_file_update

    sdi3k_rt_build_filenames, skysrc, skydest, calsrc, caldest, semaphore, messages
   if strupcase(getenv('SDI3K_SKIP_REALTIME_FILE_UPDATE') eq 'YES') then goto, skip_file_update
